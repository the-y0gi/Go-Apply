...
//     { id: 2, title: "Start applying", icon: BookOpen },
//     { id: 3, title: "Review & submit", icon: CheckCircle },
//     { id: 4, title: "Get your results", icon: FileText },
//     { id: 5, title: "Apply for visa", icon: Plane },
//     { id: 6, title: "Enrol & settle", icon: Home },
//   ]
...
//       >
//         <h1 className="text-3xl font-semibold text-center mb-8">My Progress</h1>

//         {/* Steps progress */}
//         <div className="flex flex-wrap justify-center gap-8 mb-10">
//           {steps.map((step) => (
//             <div key={step.id} className="flex flex-col items-center text-center">
//               <div className="w-14 h-14 flex items-center justify-center rounded-full bg-primary/10 border border-primary/30 mb-2">
...
//       >
//         <h2 className="text-xl font-semibold mb-2">Before Applying</h2>
...
//       >
//         <h2 className="text-xl font-semibold mb-2">Start Applying</h2>
//         <p className="text-muted-foreground mb-4">
//           Begin exploring programs and submitting applications.
//         </p>
//         <Button
//           size="lg"
//           variant="outline"
...
//   const steps = [
//     { id: 1, title: "Complete Profile", icon: User },
//     { id: 2, title: "Find Programs", icon: BookOpen },
