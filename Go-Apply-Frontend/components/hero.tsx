...
export default function Hero() {
  ...
  // };
   ...
   const handleSearchPrograms = (e: React.MouseEvent<HTMLButtonElement>) => {
    e.preventDefault(); // prevents form submission reload
    router.push("/programs"); // navigates to /programs
  };
      ...
      <div className="relative z-20 mx-auto max-w-6xl px-4 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-prose">
              Search programs across countries, compare requirements, check
              eligibility, and apply with guided support.
            </p>
